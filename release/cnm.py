...
# enty = scan_dic()
# s1 = enty.header
h3 = {"Host":"ssl.kohsocialapp.qq.com:10001","Content-Type":"application/x-www-form-urlencoded","Accept-Encoding":"br, gzip, deflate","Cookie":"pgv_pvid=5457054890; pgv_pvi=3969268736; eas_sid=u1I5h738S2D27572c8D8M1K0y0","Connection":"keep-alive","Accept":"*/*","User-Agent":"smoba/3.46.202 (iPhone; iOS 12.3.1; Scale/2.00)","Accept-Language":"zh-Hans-CN;q=1, zh-Hant-CN;q=0.9, ko-KR;q=0.8","noencrypt":"1","Content-Length":"697" }
...
response = requests.post("https://ssl.kohsocialapp.qq.com:10001/play/getmatchlist", headers=h3,data=d3 )
print(1)
print(response)
print(response.text)
